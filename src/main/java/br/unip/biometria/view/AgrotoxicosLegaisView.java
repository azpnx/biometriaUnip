...
public class AgrotoxicosLegaisView extends javax.swing.JFrame {

    public AgrotoxicosLegaisView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Agrotoxicos Legais");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        List<Agrotoxico> agrotoxicos = BiometriaDAO.listaAgrotoxicosLegais();
    ...
    public static void main(String args[]) {
       ...
       java.awt.EventQueue.invokeLater(() -> {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgrotoxicosLegaisView().setVisible(true);
            }
        });
    }
